...
class GooglePlaces
{
    ...
    */
    ...
    const PAGETOKEN_URL     = 'https://maps.googleapis.com/maps/api/place/search/json';
    const RADAR_SEARCH_URL  = 'https://maps.googleapis.com/maps/api/place/radarsearch/json';
    ...
    */
    ...
    function __set($variable, $value):void
    {
            ...
            switch ($method) {
                ...
                case 'textsearch':
                    ...
                    if (empty($parameters['query'])) {
                        throw new \Exception('A Text Search request must include at least one of keyword.');
                    }
                    if (isset($parameters['rankby'])) {
                        unset($this->rankby, $parameters['rankby']);
                    }
